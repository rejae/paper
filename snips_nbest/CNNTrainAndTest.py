...
#                     feed_dict)
            ...
            def testDataEvaluate(test_x, test_y, writer=None):
                """
                ...
                step, loss_asr, accuracy_asr, predictions_asr,scores_asr = sess.run(
                    [global_step, cnn.loss, cnn.accuracy_asr, cnn.predictions_asr,cnn.scores_asr],
                    feed_dict)
                time_str = datetime.datetime.now().isoformat()
                log.info("----------------------------------------------------")
...
#                     log.info("Saved model checkpoint to {}\n".format(path))
            ...
            testDataEvaluate(test_x, test_y, writer=None)#dev_summary_writer

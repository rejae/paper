...
outdir='/home/wangzexun/notespace/qinjie/Concatenate_Classify_MoreFeature/result'


# train_names=[ "train_set"+str(i)+".txt" for i in range(2,18,2)]
# test_names =[ "test_set"+str(i)+".txt" for i in range(2,18,2)]
...
for train_name,test_name in zip(train_names,test_names):
    ...
    datadir='/home/wangzexun/notespace/qinjie/Concatenate_Classify_MoreFeature/data'
    ...
    for i in range(3):
        ...
        modeldir = os.path.join(outdir,  ''.join(train_name)+'1202_'+str(i)) #模型名字为train_set+'i'
